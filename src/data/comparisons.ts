...
export const comparisons: ComparisonPage[] = [
  {
    ...
    features: [
      ...
      { feature: 'ACR lens', resumeForge: 'Educational rating framework', tool: 'ATS-oriented product category' },
    ],
  },
  {
    slug: 'teal',
    ...
    features: [
      { feature: 'Primary purpose', resumeForge: 'Research and knowledge library', tool: 'Career workflow platform' },
      { feature: 'Job tracking', resumeForge: 'No', tool: 'Category strength' },
      { feature: 'RRI support', resumeForge: 'Framework education', tool: 'Tailoring workflow support' },
      { feature: 'ARS support', resumeForge: 'Strong conceptual fit', tool: 'Strong workflow fit' },
      { feature: 'ACR lens', resumeForge: 'Explained in methodology', tool: 'Depends on resume workflow' },
    ],
  },
  {
    slug: 'resume-io',
    name: 'Resume.io',
    description:
      'A neutral comparison of ResumeForge AI and Resume.io-style resume builders focused on templates and document creation.',
    ...
    chooseResumeForge:
      'Choose ResumeForge AI when you need guidance before choosing a template or builder workflow.',
    chooseTool:
      'Choose Resume.io-style tooling when the immediate task is producing a formatted resume document.',
    features: [
      { feature: 'Primary purpose', resumeForge: 'Educational authority site', tool: 'Resume builder' },
      { feature: 'Templates', resumeForge: 'Explained conceptually', tool: 'Core product surface' },
      { feature: 'RRI support', resumeForge: 'Readiness methodology', tool: 'Template and content workflow' },
      { feature: 'ARS support', resumeForge: 'Broader application guidance', tool: 'Document-centered' },
      { feature: 'ACR lens', resumeForge: 'Rating framework', tool: 'Template-dependent' },
    ],
  },
  {
    slug: 'kickresume',
    name: 'Kickresume',
    description:
      'A neutral comparison of ResumeForge AI and Kickresume-style AI-assisted resume builder workflows.',
    ...
    chooseResumeForge:
      'Choose ResumeForge AI for neutral frameworks and educational guidance about AI resume tools.',
    chooseTool:
    ...
    features: [
      ...
      { feature: 'ACR lens', resumeForge: 'Compatibility education', tool: 'Template-dependent' },
    ],
  },
  {
    slug: 'zety',
    name: 'Zety',
    description:
      'A neutral comparison of ResumeForge AI and Zety-style resume builders for templates, examples, and document workflows.',
    ...
    chooseResumeForge:
      'Choose ResumeForge AI when you want research, methodology, and internally linked resume guidance.',
    chooseTool:
      'Choose Zety-style tooling when you want a builder interface and template-led resume creation.',
    features: [
      { feature: 'Primary purpose', resumeForge: 'Topical authority website', tool: 'Resume builder' },
      { feature: 'Examples', resumeForge: 'Educational guides', tool: 'Builder-oriented examples' },
      { feature: 'RRI support', resumeForge: 'Readiness framework', tool: 'Document workflow' },
      { feature: 'ARS support', resumeForge: 'Broader preparation model', tool: 'Mostly resume and cover-letter workflow' },
      { feature: 'ACR lens', resumeForge: 'Educational rating', tool: 'Template-dependent' },
    ],
  },
]
