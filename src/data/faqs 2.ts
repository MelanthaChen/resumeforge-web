export const faqs = [
  ...
  {
    question: 'How is the experiment measured?',
    answer:
      'The app stores local page view events in the browser and displays aggregate visit, page, and referrer data on the analytics page.',
  },
]
